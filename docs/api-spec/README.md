...
| API-006-1 | 로그인 및 회원가입 | 회원탈퇴 | DELETE | `/api/auth/me` | Yes | [DELETE-api-auth-me.md](./DELETE-api-auth-me.md) |
...
| API-012-1 | 웹 콘텐츠 분석 | 스크린샷 분석 요청 | POST | `/api/analysis-requests/screenshot` | Yes | [POST-api-analysis-requests-screenshot.md](./POST-api-analysis-requests-screenshot.md) |
...
| API-021 | 온보딩 관심사 | 관심사 목록 조회 | GET | `/api/interests` | Yes | [GET-api-interests.md](./GET-api-interests.md) |
| API-022 | 온보딩 관심사 | 관심사 종류 목록 조회 | GET | `/api/interests/types` | Yes | [GET-api-interests-types.md](./GET-api-interests-types.md) |
