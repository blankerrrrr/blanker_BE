...
| `uk_interests_catalog_title_genre` | `interestCatalogId`, `title`, `genre` | 동일 종류/장르 내 관심사 중복 방지 |

### 4.4 `interest_targets`
