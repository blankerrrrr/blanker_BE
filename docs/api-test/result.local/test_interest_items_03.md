...
- 정상 작동하는 API: `/api/interest-items`, `/api/interest-items/{interestItemId}`, `/api/interest-items/urls`
- 실패 및 수정이 필요한 API: 없음

### 1. GET /api/interest-items?page=1&size=20
